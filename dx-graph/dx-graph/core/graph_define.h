...
//============改变一下宏定义调节性能========================================================
#define RECV_BUFFER_SIZE 40000000   //每个计算节点接收数据的大小 40M 这个必须以字节为单位计数
#define SEND_BUFFER_SIZE 2000000	//发送缓存的大小 2M   以update大小为单位计数
...
//worker节点的接收和发送还粗
#define IN_BUFFER_SIZE 10000000 //接收缓存大小 5M update大小为单位
#define OUT_BUFFER_SIZE 10000000 //发送缓冲区大小 5M update大小为单位
//============================================================================================
